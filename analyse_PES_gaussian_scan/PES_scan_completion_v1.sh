...
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt
...
grep -o 'Stationary point found' "$type_sugar"_"$ru"_"$IL"_scan.log | wc -l > number_conformers_that_converged.txt

else

grep -o 'Stationary point found' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan.log | wc -l > number_conformers_that_converged.txt
...
echo "Scan of environment: $environment, TC: $type_sugar, TC ring conf: $sugar_ring, RU: $ru, IL: $IL finished normally" >> $MD_RUN/nucleotides_c+d/gaussian_scan/list_PES_scans_that_finished_normally_"$environment".log
...
if [ "$sugar_ring" == "none" ]; then
awk '/-- Stationary point found./{c++} c=='$structure_from_scan'{print NR;exit}' "$type_sugar"_"$ru"_"$IL"_scan.log > line_number_conv_message.txt
line_number_with_conv_message=`cat line_number_conv_message.txt`
else
awk '/-- Stationary point found./{c++} c=='$structure_from_scan'{print NR;exit}' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan.log > line_number_conv_message.txt
line_number_with_conv_message=`cat line_number_conv_message.txt`
fi
...
if [ "$sugar_ring" == "none" ]; then
sed -n '1,'$line_number_with_conv_message'p' "$type_sugar"_"$ru"_"$IL"_scan.log > structure#"$structure_from_scan"_file.txt 
else
sed -n '1,'$line_number_with_conv_message'p' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan.log > structure#"$structure_from_scan"_file.txt 
fi
...
# Get line number of each instance of -- Stationary point found.
if [ "$sugar_ring" == "none" ]; then
awk '/-- Stationary point found./{c++} c=='$previous_structure_from_scan'{print NR;exit}' "$type_sugar"_"$ru"_"$IL"_scan.log > previous_line_number_conv_message.txt
previous_line_number_with_conv_message=`cat previous_line_number_conv_message.txt`
sed -n ''$previous_line_number_with_conv_message','$line_number_with_conv_message'p' "$type_sugar"_"$ru"_"$IL"_scan.log > structure#"$structure_from_scan"_file.txt 
else
awk '/-- Stationary point found./{c++} c=='$previous_structure_from_scan'{print NR;exit}' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan.log > previous_line_number_conv_message.txt
previous_line_number_with_conv_message=`cat previous_line_number_conv_message.txt`
sed -n ''$previous_line_number_with_conv_message','$line_number_with_conv_message'p' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan.log > structure#"$structure_from_scan"_file.txt 
fi
...
cat $MD_RUN/instructions_DFT/instructions_b3lyp.txt title_gjf_file.txt nucleotide.gjf > tmp.txt && mv tmp.txt "$type_sugar"_"$ru"_"$IL"_min.gjf
echo " " >> "$type_sugar"_"$ru"_"$IL"_min.gjf
# Replace name of chk file in final gjf file
sed -i 's/%chk=2deoxyribo_beta_vacuum_cell21.chk/%chk='$type_sugar'_'$ru'_'$IL'_min.chk/g' "$type_sugar"_"$ru"_"$IL"_min.gjf
# Delete last 2 lines of this file
head -n -2 "$type_sugar"_"$ru"_"$IL"_min.gjf > tmp.txt && mv tmp.txt "$type_sugar"_"$ru"_"$IL"_min.gjf
# Substitute keywords for the case of water opt
if [ "$environment" == "water" ]; then
sed -i 's/scf=maxcycle=1600/scf=maxcycle=1600 scrf=(solvent=water)/g' "$type_sugar"_"$ru"_"$IL"_min.gjf
fi
# Replace instructions for DFT calculation
sed -i 's/opt=modredundant/opt=calcall freq/g' "$type_sugar"_"$ru"_"$IL"_min.gjf
sed -i 's/6-31g(d,p)/6-311++g(d,p)/g' "$type_sugar"_"$ru"_"$IL"_min.gjf
# Delete first line from file
#sed -i 1,1d "$type_sugar"_"$ru"_"$IL"_min.gjf
# Replace RAM and PROC info
sed -i 's/%nprocshared=64/%nprocshared=16/g' "$type_sugar"_"$ru"_"$IL"_min.gjf
sed -i 's/%mem=160GB/%mem=16GB/g' "$type_sugar"_"$ru"_"$IL"_min.gjf
# Add empty line at the end
echo "" >> "$type_sugar"_"$ru"_"$IL"_min.gjf
# Remove last 4 lines
head -n -3 "$type_sugar"_"$ru"_"$IL"_min.gjf > tmp.gjf && mv tmp.gjf "$type_sugar"_"$ru"_"$IL"_min.gjf
echo "" >> "$type_sugar"_"$ru"_"$IL"_min.gjf
# Copy file to corresponding folder
cp "$type_sugar"_"$ru"_"$IL"_min.gjf $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$type_sugar/$IL/$ru
# Copy job1 bash to this folder
cp $MD_RUN/job1.sh $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$type_sugar/$IL/$ru
# Replace name of file to calculate in job1
sed -i 's/g16 input.gjf/g16 '$type_sugar'_'$ru'_'$IL'_min.gjf/g' $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$type_sugar/$IL/$ru/job1.sh

else

cat $MD_RUN/instructions_DFT/instructions_b3lyp.txt title_gjf_file.txt nucleotide.gjf > tmp.txt && mv tmp.txt "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
echo " " >> "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
# Replace name of chk file in final gjf file
sed -i 's/%chk=2deoxyribo_beta_vacuum_cell21.chk/%chk='$type_sugar'_'$sugar_ring'_'$ru'_'$IL'_min.chk/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
# Delete last 2 lines of this file
head -n -2 "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf > tmp.txt && mv tmp.txt "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
# Substitute keywords for the case of water opt
if [ "$environment" == "water" ]; then
sed -i 's/scf=maxcycle=1600/scf=maxcycle=1600 scrf=(solvent=water)/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
fi
# Replace instructions for DFT calculation
sed -i 's/opt=modredundant/opt=calcall freq/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
sed -i 's/6-31g(d,p)/6-311++g(d,p)/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
# Delete first line from file
#sed -i 1,1d "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
# Replace RAM and PROC info
sed -i 's/%nprocshared=64/%nprocshared=16/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
sed -i 's/%mem=160GB/%mem=16GB/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
# Add empty line at the end
echo "" >> "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
# Remove last 4 lines
head -n -3 "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf > tmp.gjf && mv tmp.gjf "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
echo "" >> "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf
# Copy file to corresponding folder
cp "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_min.gjf $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$type_sugar/$sugar_ring/$IL/$ru
# Copy job1 bash to this folder
cp $MD_RUN/job1.sh $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$type_sugar/$sugar_ring/$IL/$ru
# Replace name of file to calculate in job1
sed -i 's/g16 input.gjf/g16 '$type_sugar'_'$sugar_ring'_'$ru'_'$IL'_min.gjf/g' $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$type_sugar/$sugar_ring/$IL/$ru/job1.sh
...
if [ "$sugar_ring" == "none" ]; then
grep 'This type of calculation cannot be archived.' "$type_sugar"_"$ru"_"$IL"_scan.log > message_about_archived_data.txt
else
grep 'This type of calculation cannot be archived.' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan.log > message_about_archived_data.txt
fi
...
if [ "$sugar_ring" == "none" ]; then
echo "$type_sugar/$IL/$ru finished normally (but the type of calculation cannot be archived)" >> $MD_RUN/nucleotides_c+d/gaussian_scan/list_PES_scans_no_archived_"$environment".log
else
echo "$type_sugar/$sugar_ring/$IL/$ru finished normally (but the type of calculation cannot be archived)" >> $MD_RUN/nucleotides_c+d/gaussian_scan/list_PES_scans_no_archived_"$environment".log
fi
...
if [ "$sugar_ring" == "none" ]; then
echo "$environment/$type_sugar/$IL/$ru DID NOT FINISH NORMALLY" >> $MD_RUN/nucleotides_c+d/gaussian_scan/list_PES_scans_that_didnt_finished_normally_"$environment".log
else
echo "$environment/$type_sugar/$sugar_ring/$IL/$ru DID NOT FINISH NORMALLY" >> $MD_RUN/nucleotides_c+d/gaussian_scan/list_PES_scans_that_didnt_finished_normally_"$environment".log 
fi
...
if [ "$sugar_ring" == "none" ]; then
obabel "$type_sugar"_"$ru"_"$IL"_scan.log -O nucleotide.gjf
else
obabel "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan.log -O nucleotide.gjf
fi

# Delete first two lines from final gjf file
sed -i 1,2d nucleotide.gjf

# Attach DFT instructions
cat $MD_RUN/instructions_DFT/instructions_b3lyp.txt nucleotide.gjf > nucleotide2.gjf

# Delete instructions for cherif cluster
#sed -i 1,1d nucleotide2.gjf

# Substitute keywords for the case of water opt
if [ "$environment" == "water" ]; then
sed -i 's/scf=maxcycle=1600/scf=maxcycle=1600 scrf=(solvent=water)/g' nucleotide2.gjf
fi
...
# Change name of file
mv nucleotide2.gjf "$type_sugar"_"$ru"_"$IL"_scan2.gjf

# Copy in current folder job1
cp $MD_RUN/job1.sh .

# Replace name of file by backbone name in job1 script
sed -i 's/g16 input.gjf/g16 '$type_sugar'_'$ru'_'$IL'_scan2.gjf/g' job1.sh

# Replace name of chk file in second scan file
sed -i 's/%chk=2deoxyribo_beta_vacuum_cell21.chk/%chk='$type_sugar'_'$ru'_'$IL'_scan.chk/g' "$type_sugar"_"$ru"_"$IL"_scan2.gjf

# Replace gaussian instructions for recalculate the scan
sed -i 's/opt=modredundant/opt=(tight,readfc) geom=allcheck guess=read int=ultrafine/g' "$type_sugar"_"$ru"_"$IL"_scan2.gjf

# Replace RAM and PROC info
sed -i 's/%nprocshared=64/%nprocshared=16/g' "$type_sugar"_"$ru"_"$IL"_scan2.gjf
sed -i 's/%mem=160GB/%mem=16GB/g' "$type_sugar"_"$ru"_"$IL"_scan2.gjf

else

# Rename file
mv nucleotide2.gjf "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan2.gjf

# Copy job script in current folder
cp $MD_RUN/job1.sh .

# Replace name of file by backbone name
sed -i 's/g16 input.gjf/g16 '$type_sugar'_'$sugar_ring'_'$ru'_'$IL'_scan2.gjf/g' job1.sh

# Replace name of chk file in second scan file
sed -i 's/%chk=2deoxyribo_beta_vacuum_cell21.chk/%chk='$type_sugar'_'$sugar_ring'_'$ru'_'$IL'_scan.chk/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan2.gjf

# Replace gaussian instructions for recalculate the scan
sed -i 's/opt=modredundant/opt=(tight,readfc) geom=allcheck guess=read int=ultrafine/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan2.gjf

# Replace RAM and PROC info
sed -i 's/%nprocshared=64/%nprocshared=16/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan2.gjf
sed -i 's/%mem=160GB/%mem=16GB/g' "$type_sugar"_"$sugar_ring"_"$ru"_"$IL"_scan2.gjf
...
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC/$ring_conf_fura
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC/$ring_conf_fura/$IL
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC/$ring_conf_fura/$IL/$RU
...
completion_status $environment $TC $ring_conf_fura $RU $IL
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC/$ring_conf_pyra
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC/$ring_conf_pyra/$IL
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC/$ring_conf_pyra/$IL/$RU
...
# Run function that generates the nucleotide
completion_status $environment $TC $ring_conf_pyra $RU $IL
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC/$IL
...
# Create corresponding folder in final_gaussian_opt folder
mkdir $MD_RUN/nucleotides_c+d/final_gaussian_opt/$environment/$TC/$IL/$RU
...
# Run function that generates the nucleotide
completion_status $environment $TC $ring_conf $RU $IL
