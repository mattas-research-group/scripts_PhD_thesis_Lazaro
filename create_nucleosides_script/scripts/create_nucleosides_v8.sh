...
read -p "insert conformation of the sugar ring)" sugar_ring


# Convert both files for the sugar and base to gzmat
obabel *.log -O *.gzmat

if [ "$ru" == "BA_cbond" ] || [ "$ru" == "BA_nbond" ] || [ "$ru" == "TARC_cbond" ] || [ "$ru" == "TARC_nbond" ]; then
...
elif [ "$type_sugar" == "2deoxy_ribopyranose" ] && [ "$type_anomer" == "alpha" ]; then
...
elif [ "$type_sugar" == "ribopyranose" ] && [ "$type_anomer" == "alpha" ]; then
...
elif [ "$type_sugar" == "2deoxy_ribopyranose" ] || [ "$type_sugar" == "ribopyranose" ] && [ "$type_anomer" == "beta" ]; then
...
elif [ "$ru" == "BA_nbond" ] && [ "$type_anomer" == "alpha" ]; then
if [ "$lines" == 4 ]; then
awk 'NR=='$lines' { print $1, $2, $3, $4, $5, $6='$anomer', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
elif [ "$lines" == 9 ]; then
awk 'NR=='$lines' { print $1, $2, $3, $4='$anomer', $5, $6='$hemiacetal_O', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
...
elif [ "$ru" == "BA_nbond" ] && [ "$type_anomer" == "beta" ]; then
if [ "$lines" == 4 ]; then
awk 'NR=='$lines' { print $1, $2, $3, $4, $5, $6='$anomer', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
elif [ "$lines" == 9 ]; then
awk 'NR=='$lines' { print $1, $2, $3, $4='$anomer', $5, $6='$hemiacetal_O', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
...
awk 'NR=='$lines' { print $1, $2=$2+5, $3, $4=$4+2, $5, $6=$6-1, $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
elif [ "$lines" == 12 ]; then
awk 'NR=='$lines' { print $1, $2=$2-1, $3, $4, $5, $6, $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
else
awk 'NR=='$lines' { print $1, $2, $3, $4, $5, $6, $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
fi
...
elif [ "$type_sugar" == "2deoxy_ribopyranose" ] || [ "$type_sugar" == "ribopyranose" ] && [ "$sugar_ring" == "D1C4" ] && [ "$ru" == "adenine" ] || [ "$ru" == "guanine" ]; then
...
elif [ "$type_sugar" == "2deoxy_ribopyranose" ] || [ "$type_sugar" == "ribopyranose" ] && [ "$sugar_ring" == "D4C1" ] && [ "$ru" == "adenine" ] || [ "$ru" == "guanine" ]; then
...
elif [ "$type_sugar" == "2deoxy_ribofuranose" ] || [ "$type_sugar" == "ribofuranose" ] || [ "$type_sugar" == "threose" ] && [ "$ru" == "cytosine" ] || [ "$ru" == "thymine" ] || [ "$ru" == "uracil" ];
...
echo "a1= 110.03" >> first_int_coord_base.txt # a1=113.40
echo "d1= 203.16" >> first_int_coord_base.txt # d1=89.74

# Insert a2 d2 and d3 for BA_nbond 
sed -i '2 i a2= 119.45' internal_coordinates_values_base.txt # a2=116.51
sed -i '3 i d2= 167.28' internal_coordinates_values_base.txt # d2=43.05
sed -i '6 i d3=   1.76' internal_coordinates_values_base.txt # d3=0.40

# Insert other dihedral angles for BA_nbond
sed -i '1s/.*/r2= 1.4163/' internal_coordinates_values_base.txt

sed -i '5s/.*/a3= 119.85/' internal_coordinates_values_base.txt

sed -i '8s/.*/a4=  84.97/' internal_coordinates_values_base.txt
sed -i '9s/.*/d4= 181.76/' internal_coordinates_values_base.txt

sed -i '23s/.*/a9= 112.77/' internal_coordinates_values_base.txt
sed -i '24s/.*/d9= 348.79/' internal_coordinates_values_base.txt

sed -i '27s/.*/d10= 358.34/' internal_coordinates_values_base.txt

sed -i '29s/.*/a11= 119.66/' internal_coordinates_values_base.txt
sed -i '30s/.*/d11= 179.97/' internal_coordinates_values_base.txt

sed -i '32s/.*/a12= 122.20/' internal_coordinates_values_base.txt
...
elif [ "$ru" == "thymine" ] || [ "$ru" == "uracil" ] && [ "$type_sugar" == "2deoxy_ribofuranose" ] || [ "$type_sugar" == "ribofuranose" ] || [ "$type_sugar" == "threose" ]; then
awk 'NR=='$line' {$0="'$value'= 181.26"} 1' internal_coordinates_base_sinH.gzmat > internal_coordinates_base_sinH_v2.gzmat
elif [ "$ru" == "adenine" ] || [ "$ru" == "guanine" ] || [ "$ru" == "cytosine" ] && [ "$sugar_ring" == "D1C4" ] && [ "$type_sugar" == "2deoxy_ribopyranose" ] || [ "$type_sugar" == "ribopyranose" ]; then
awk 'NR=='$line' {$0="'$value'= 356.15"} 1' internal_coordinates_base_sinH.gzmat > internal_coordinates_base_sinH_v2.gzmat
elif [ "$ru" == "adenine" ] || [ "$ru" == "guanine" ] || [ "$ru" == "cytosine" ] && [ "$sugar_ring" == "D4C1" ] && [ "$type_sugar" == "2deoxy_ribopyranose" ] || [ "$type_sugar" == "ribopyranose" ]; then
