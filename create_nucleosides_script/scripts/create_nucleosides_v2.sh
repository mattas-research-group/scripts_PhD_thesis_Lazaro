...
read -p "insert type of sugar in case that it is (e.g. , or alpha, or none if there is not anomer)" type_sugar
...
sed -i '/r'$hydrogen'/d' internal_coordinates_base.txt
sed -i '/a'$hydrogen'/d' internal_coordinates_base.txt
sed -i '/d'$hydrogen'/d' internal_coordinates_base.txt
