...
read -p "In case of a pyranose specify sugar ring conformation)" ring_conf
...
# Add conditions to select hydroxil to be deleted from sugar and anomeric carbon, hemiacetalic oxygen and previous atom to oxygen in sugar 
if [ "$type_sugar" == "2deoxy_ribofuranose" ] && [ "$ring_conf" == "2endo" ]; then

oxygen=17 # oxygen to be deleted
hydrogen=18 # hydrogen to be deleted

if [ "$type_anomer" == "alpha" ] && [ "$ru" == "adenine" ] || [ "$ru" == "guanine" ] || [ "$ru" == "cytosine" ] || [ "$ru" == "thymine" ] || [ "$ru" == "uracil" ] || [ "$ru" == "CA" ] || [ "$ru" == "melamine" ] || [ "$ru" == "TARC_nbond" ]; then
anomer=8
hemiacetal_O=4
atom_before_hemiacetal=3
elif [ "$type_anomer" == "alpha" ] && [ "$ru" == "BA_cbond" ] || [ "$ru" == "BA_nbond" ] || [ "$ru" == "TARC_cbond" ]; then
anomer=16
hemiacetal_O=6
atom_before_hemiacetal=5
elif [ "$type_anomer" == "beta" ]; then
anomer=8
hemiacetal_O=4
atom_before_hemiacetal=3
fi

elif [ "$type_sugar" == "ribofuranose" ] && [ "$ring_conf" == "2endo" ]; then

oxygen=19 # oxygen to be deleted
hydrogen=20 # hydrogen to be deleted
...
elif [ "$type_sugar" == "threose" ] && && [ "$ring_conf" == "2endo" ]; then

oxygen=15 # oxygen to be deleted
hydrogen=16 # hydrogen to be deleted

if [ "$type_anomer" == "alpha" ] && [ "$ru" == "adenine" ] || [ "$ru" == "guanine" ] || [ "$ru" == "cytosine" ] || [ "$ru" == "thymine" ] || [ "$ru" == "uracil" ] || [ "$ru" == "CA" ] || [ "$ru" == "melamine" ] || [ "$ru" == "TARC_nbond" ]; then
anomer=5
hemiacetal_O=2
atom_before_hemiacetal=1
elif [ "$type_anomer" == "alpha" ] && [ "$ru" == "BA_cbond" ] || [ "$ru" == "BA_nbond" ] || [ "$ru" == "TARC_cbond" ]; then
anomer=14
hemiacetal_O=13
atom_before_hemiacetal=3
...
#elif [ "$type_sugar" == "2deoxy_ribopyranose" ] && [ "$ring_conf" == "D1C4" ]; then

#oxygen=17 # oxygen to be deleted
#hydrogen=18 # hydrogen to be deleted

#if [ "$type_anomer" == "alpha" ] && [ "$ru" == "adenine" ] || [ "$ru" == "guanine" ] || [ "$ru" == "cytosine" ] || [ "$ru" == "thymine" ] || [ "$ru" == "uracil" ] || #[ "$ru" == "CA" ] || [ "$ru" == "melamine" ]; then
#anomer=1
#hemiacetal_O=6
#atom_before_hemiacetal=5
#elif [ "$type_anomer" == "alpha" ] && [ "$ru" == "BA_cbond" ] || [ "$ru" == "BA_nbond" ] || [ "$ru" == "TARC_cbond" ] || [ "$ru" == "TARC_nbond" ]; then
#anomer=1
#hemiacetal_O=2
#atom_before_hemiacetal=3
#elif [ "$type_anomer" == "beta" ]; then
...
#elif [ "$type_sugar" == "2deoxy_ribopyranose" ] && [ "$ring_conf" == "D4C1" ]; then
...
sed ''$line_oxygen','$line_oxygen'd' $tc.gzmat > sugar_sin_OH1.gzmat
sed ''$line_hydrogen','$line_hydrogen'd' sugar_sin_OH1.gzmat > sugar_sin_OH.gzmat
...
lines_sugar_sinOH=$(($atoms_sugar_ion+5))
...
# Eliminate lines that correspond to 
...
################################## Replace values #r, #a and #d in this final file by right labels ###################################
for lines in $(seq 1 1 $lines_sugar_sinOH)

do

if [[ "$lines" -ge "$oxygen" ]] && [[ "$lines" -lt "$hydrogen"  ]]; then
# Calculate new r# a# and d#
new_labels_number_base=$(($lines-1))
sed -i ''$lines's/r'$lines'/r'$new_labels_number_base'/' no_int_coord_sugar_sinOH.gzmat
sed -i ''$lines's/a'$lines'/a'$new_labels_number_base'/' no_int_coord_sugar_sinOH.gzmat
sed -i ''$lines's/d'$lines'/d'$new_labels_number_base'/' no_int_coord_sugar_sinOH.gzmat
sed -i -e 's/r'$lines'/r'$new_labels_number_base'/g' internal_coordinates_values_sugar_sinOH.txt
sed -i -e 's/a'$lines'/a'$new_labels_number_base'/g' internal_coordinates_values_sugar_sinOH.txt
sed -i -e 's/d'$lines'/d'$new_labels_number_base'/g' internal_coordinates_values_sugar_sinOH.txt
elif [[ "$lines" -ge "$hydrogen" ]]; then
new_labels_number_base=$(($lines-2))
sed -i ''$lines's/r'$lines'/r'$new_labels_number_base'/' no_int_coord_sugar_sinOH.gzmat
sed -i ''$lines's/a'$lines'/a'$new_labels_number_base'/' no_int_coord_sugar_sinOH.gzmat
sed -i ''$lines's/d'$lines'/d'$new_labels_number_base'/' no_int_coord_sugar_sinOH.gzmat
sed -i -e 's/r'$lines'/r'$new_labels_number_base'/g' internal_coordinates_values_sugar_sinOH.txt
...
# Delete line with hydrogen to create z matrix for ionic base: same as delete hydrogen from base to create ion 
...
elif [ "$ru" == "TARC_cbond" ] && [ "$type_anomer" == "alpha" ]; then
if [ "$lines" == 8 ]; then
awk 'NR=='$lines' { print $1, $2=$2-4, $3, $4='$anomer', $5, $6='$hemiacetal_O', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
elif [ "$lines" == 13 ]; then
awk 'NR=='$lines' { print $1, $2, $3, $4='$anomer', $5, $6='$hemiacetal_O', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
elif [ "$lines" == 14 ]; then
awk 'NR=='$lines' { print $1, $2, $3, $4, $5, $6='$anomer', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
...
awk 'NR=='$lines' { print $1, $2, $3, $4=$4-4, $5, $6='$anomer', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
else
awk 'NR=='$lines' { print $1, $2, $3, $4, $5, $6, $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
fi

elif [ "$ru" == "TARC_cbond" ] && [ "$type_anomer" == "beta" ]; then
if [ "$lines" == 8 ]; then
awk 'NR=='$lines' { print $1, $2=$2-4, $3, $4='$anomer', $5, $6='$hemiacetal_O', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
elif [ "$lines" == 13 ]; then
awk 'NR=='$lines' { print $1, $2, $3, $4='$anomer', $5, $6='$hemiacetal_O', $7 }' no_int_coord_base_labels_fixed_v2.txt >> no_int_coord_base_labels_fixed_v3.txt
...
echo "a1= 136.98" >> first_int_coord_base.txt 
echo "d1=  68.68" >> first_int_coord_base.txt 

# Insert a2 d2 and d3 for BA_nbond 
sed -i '2 i a2=  76.91' internal_coordinates_values_base.txt 
sed -i '3 i d2= 246.67' internal_coordinates_values_base.txt 
sed -i '6 i d3=  257.47' internal_coordinates_values_base.txt 
...
echo "r1= 2.0284" > first_int_coord_base.txt
echo "a1= 145.55" >> first_int_coord_base.txt 
echo "d1=  68.86" >> first_int_coord_base.txt 

# Insert a2 d2 and d3 for TARC_cbond 
sed -i '2 i a2= 109.81' internal_coordinates_values_base.txt  
sed -i '3 i d2= 134.64' internal_coordinates_values_base.txt  
sed -i '6 i d3=  84.87' internal_coordinates_values_base.txt 

# Insert other dihedral angles for TARC_cbond
sed -i '20s/.*/a8=  75.89/' internal_coordinates_values_base.txt
sed -i '21s/.*/d8= 254.54/' internal_coordinates_values_base.txt

# Insert other dihedral angles for TARC_cbond
sed -i '35s/.*/a13=  83.88/' internal_coordinates_values_base.txt
sed -i '36s/.*/d13=  19.40/' internal_coordinates_values_base.txt

sed -i '39s/.*/d14= 268.79/' internal_coordinates_values_base.txt

sed -i '42s/.*/d14= 124.30/' internal_coordinates_values_base.txt

elif [ "$ru" == "TARC_nbond" ]; then
# Insert a, d for TARC_nbond
echo "r1= 2.4318" > first_int_coord_base.txt
echo "a1=  82.06" >> first_int_coord_base.txt 
echo "d1=  94.75" >> first_int_coord_base.txt 

# Insert a2 d2 and d3 for TARC_nbond 
sed -i '2 i a2=  81.98' internal_coordinates_values_base.txt  
sed -i '3 i d2=  21.03' internal_coordinates_values_base.txt  
sed -i '6 i d3= 185.98' internal_coordinates_values_base.txt 

sed -i '20s/.*/a8= 154.75/' internal_coordinates_values_base.txt
sed -i '21s/.*/d8= 214.26/' internal_coordinates_values_base.txt

sed -i '35s/.*/a13=  34.77/' internal_coordinates_values_base.txt
sed -i '36s/.*/d13= 187.78/' internal_coordinates_values_base.txt

sed -i '39s/.*/d14= 145.14/' internal_coordinates_values_base.txt

sed -i '42s/.*/d16= 344.59/' internal_coordinates_values_base.txt
...
# Insert a, d for TARC_cbond
echo "r1= 2.5774" > first_int_coord_base.txt
echo "a1= 136.37" >> first_int_coord_base.txt 
echo "d1= 211.52" >> first_int_coord_base.txt 

# Insert a2 d2 and d3 for TARC_cbond 
sed -i '2 i a2= 151.77' internal_coordinates_values_base.txt  
sed -i '3 i d2= 344.16' internal_coordinates_values_base.txt  
sed -i '6 i d3= 359.08' internal_coordinates_values_base.txt 

# Insert other dihedral angles for TARC_cbond
sed -i '20s/.*/a8=  29.27/' internal_coordinates_values_base.txt
sed -i '21s/.*/d8= 343.73/' internal_coordinates_values_base.txt

# Insert other dihedral angles for TARC_cbond
sed -i '35s/.*/a13=  92.43/' internal_coordinates_values_base.txt
sed -i '36s/.*/d13= 165.47/' internal_coordinates_values_base.txt

sed -i '39s/.*/d14= 339.04/' internal_coordinates_values_base.txt

sed -i '42s/.*/d14= 194.55/' internal_coordinates_values_base.txt

elif [ "$ru" == "TARC_nbond" ]; then

# Insert a, d for BA_nbond
echo "r1= 2.4396" > first_int_coord_base.txt
echo "a1=  78.01" >> first_int_coord_base.txt # a1=113.40
echo "d1= 195.55" >> first_int_coord_base.txt # d1=89.74

# Insert a2 d2 and d3 for BA_nbond 
sed -i '2 i a2=  82.21' internal_coordinates_values_base.txt # a2=116.51
sed -i '3 i d2=   3.20' internal_coordinates_values_base.txt # d2=43.05
sed -i '6 i d3= 185.56' internal_coordinates_values_base.txt # d3=0.40

# Insert other dihedral angles for TARC_cbond
sed -i '20s/.*/a8= 154.63/' internal_coordinates_values_base.txt
sed -i '21s/.*/d8= 195.53/' internal_coordinates_values_base.txt

# Insert other dihedral angles for TARC_cbond
sed -i '35s/.*/a13=  34.46/' internal_coordinates_values_base.txt
sed -i '36s/.*/d13= 170.53/' internal_coordinates_values_base.txt

sed -i '39s/.*/d14= 145.76/' internal_coordinates_values_base.txt

sed -i '42s/.*/d14= 345.65/' internal_coordinates_values_base.txt
