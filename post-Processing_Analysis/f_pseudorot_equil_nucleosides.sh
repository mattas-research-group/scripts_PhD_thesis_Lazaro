...
##################################################
##                                              ##
## FUNCTIONS TO MODIFY DELTA VALUES.            ##
##                                              ##
## Description:                                 ##
## This function modifies deltathermo# to       ##
## deltathermo with subindex integer.           ##
## e.g.,                 
##                                              ##
##################################################
...
def gen_freq_hist (dataframe, thermo):
...
for thermo in thermo_params:
    print (TC)
    print (thermo)
    gen_freq_hist (dataframe, thermo)   
