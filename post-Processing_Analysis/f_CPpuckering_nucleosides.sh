...
if TC in ["2deoxy_ribofuranose", "ribofuranose", "threose"]:
    ...
    rows = 2
    cols = 3                                                                           
    fig, axn = plt.subplots(rows, cols, sharey=False, sharex=False, figsize=(36,20))
   ...
   # elif TC == "ribopyranose":
    ...
    for i, (ax, phi2, theta, environment, phi2_alpha, phi2_beta, theta_alpha, theta_beta) in enumerate([(axn.flat[0], 
        ...
        ax.text(-20.0, -23.0, '\n\u00b9C\u2084', fontsize=34, fontweight='bold', color='black')
        #ax.text(-20.0, 180.0+3.0, '\u00b9C\u2084', fontsize=30, color='black', fontweight='bold')
        ...
        if ax == axn.flat[5]:
            ...
            ax.legend(handles=[grey_square, green_triangle], fontsize=40, bbox_to_anchor=(1.2, -0.3), loc="lower center", ncol=2)
