...
echo "$ring_conformation_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/final_ring_conformation_C_P_furanoses.txt
echo "$q2_amplitude_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/q2_C_P_furanoses.txt
echo "$total_amplitude_Q_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/total_amplitude_Q_C_P_furanoses.txt
echo "$phase_angle_phi2_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/phase_angle_phi2_Q_C_P_furanoses.txt
echo "$TC" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/TC_names_furanoses.txt
echo "$ring_conf" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/initial_ring_conf_furanoses.txt
echo "$environment" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/environment_list_furanoses.txt
...
# Output variables in general files inside the environment folder depending on the ring type
echo "$ring_conformation_pyra_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/final_ring_conformation_C_P_pyranoses.txt
echo "$q2_amplitude_pyra_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/q2_C_P_pyranoses.txt
echo "$q3_amplitude_pyra_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/q3_C_P_pyranoses.txt
echo "$total_amplitude_Q_pyra_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/total_amplitude_Q_C_P_pyranoses.txt
echo "$phase_angle_phi2_pyra_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/phase_angle_phi2_Q_C_P_pyranoses.txt
echo "$phase_angle_theta_C_P" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/phase_angle_theta_Q_C_P_pyranoses.txt
echo "$TC" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/TC_names_pyranoses.txt
echo "$ring_conf" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/initial_ring_conf_pyranoses.txt
echo "$environment" >> $MD_RUN/TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC/environment_list_pyranoses.txt
...
mkdir TC/post_proc_summary_results_csv_graphs/sugar_puckering

# Create TC folder inside the post-processing folder
for TC in "${TC_names[@]}"; do
mkdir TC/post_proc_summary_results_csv_graphs/sugar_puckering/$TC
done
...
obtain_ring_atoms_coord $environment $TC $ring_conf_fura  

# Write results to general files in analysis folder
w_results_to_analysis_folder $environment $TC $ring_conf_fura
...
# Run function to obtain the ring atoms coordinates
obtain_ring_atoms_coord $environment $TC $ring_conf_pyra  

# Write results to general files in analysis folder
w_results_to_analysis_folder $environment $TC $ring_conf_pyra
