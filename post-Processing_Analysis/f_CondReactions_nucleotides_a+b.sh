...
#	f_CondReactions_nucleotides_a+b.sh
...
echo $zero_point_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/nucleotides_zero_point_energies.txt
echo $corrected_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/nucleotides_corrected_energies.txt
echo $enthalpy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/nucleotides_enthalpies.txt
echo $free_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/nucleotides_free_energies.txt

elif [ "$component_type" == "nucleoside" ]; then
echo $zero_point_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/nucleosides_zero_point_energies.txt
echo $corrected_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/nucleosides_corrected_energies.txt
echo $enthalpy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/nucleosides_enthalpies.txt
echo $free_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/nucleosides_free_energies.txt

elif [ "$component_type" == "IL" ]; then
echo $zero_point_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/ILs_zero_point_energies.txt
echo $corrected_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/ILs_corrected_energies.txt
echo $enthalpy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/ILs_enthalpies.txt
echo $free_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/ILs_free_energies.txt

elif [ "$component_type" == "TC" ]; then
echo $zero_point_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/TCs_zero_point_energies.txt
echo $corrected_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/TCs_corrected_energies.txt
echo $enthalpy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/TCs_enthalpies.txt
echo $free_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/TCs_free_energies.txt

else # When is RU

echo $zero_point_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/RUs_zero_point_energies.txt
echo $corrected_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/RUs_corrected_energies.txt
echo $enthalpy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/RUs_enthalpies.txt
echo $free_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/RUs_free_energies.txt
...
echo $environment >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/environment_list.txt
echo $TC >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/TCs_names_list.txt
echo $ring_conf >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/ring_conf_names_list.txt
echo $IL >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/ILs_names_list.txt
echo $RU >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/RUs_names_list.txt
...
echo $zpE_water >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/water_zero_point_energies.txt
echo $corrE_water >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/water_corrected_energies.txt
echo $H_water >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/water_enthalpies.txt
echo $G_water >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL/water_free_energies.txt
...
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction

# Create IL folder inside the post-processing folder
for IL in "${IL_names[@]}"; do
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs/condensation_reaction/$IL
done
...
calc_thermo_params_cond_reaction "$TC"_"$ring_conf_fura"_"$RU".log "$TC"_"$ring_conf_fura"_"$RU" "nucleoside" $IL
calc_thermo_params_cond_reaction $IL.log $IL "IL" $IL
calc_thermo_params_cond_reaction "$TC"_"$ring_conf_fura".log "$TC"_"$ring_conf_fura" "TC" $IL
calc_thermo_params_cond_reaction $RU.log $RU "RU" $IL
...
# Run function that extract all the energies from this file and print them in corresponding summary files in processing folder
calc_thermo_params_cond_reaction $log_file $log_file_prefix "nucleotide" $IL
calc_thermo_params_cond_reaction "$TC"_"$ring_conf_pyra"_"$RU".log "$TC"_"$ring_conf_pyra"_"$RU" "nucleoside" $IL
calc_thermo_params_cond_reaction $IL.log $IL "IL" $IL
calc_thermo_params_cond_reaction "$TC"_"$ring_conf_pyra".log "$TC"_"$ring_conf_pyra" "TC" $IL
calc_thermo_params_cond_reaction $RU.log $RU "RU" $IL
...
# Run function that extract all the energies from this file and print them in corresponding summary files in processing folder
calc_thermo_params_cond_reaction $log_file $log_file_prefix "nucleotide" $IL
calc_thermo_params_cond_reaction "$TC"_"$RU".log "$TC"_"$RU" "nucleoside" $IL
calc_thermo_params_cond_reaction $IL.log $IL "IL" $IL
calc_thermo_params_cond_reaction "$TC".log "$TC" "TC" $IL
calc_thermo_params_cond_reaction $RU.log $RU "RU" $IL
        ...
        if env == "vacuum" and type_ru == "canonical":
            if TC in ['2deoxy_ribofuranose', 'ribofuranose', 'threose', '2deoxy_ribopyranose', 'ribopyranose']:
                ...
                ax1 = ru_df.plot(kind='bar', ax=ax, color='Grey', rot=360, width=0.6, edgecolor = "black", 
                                 xlabel='', ylabel='ΔG (kcal/mol)', legend=False, fontsize=28)
            ax1.set_xticks([]) 
            ax1.set_ylabel(str(thermo)+"$_{a+b}$(kJ/mol)", fontsize=28, fontdict=dict(weight='bold'))
            ...
            if TC in ['2deoxy_ribofuranose', 'ribofuranose', 'threose', '2deoxy_ribopyranose', 'ribopyranose']:
                ...
                ax3 = ru_df.plot(kind='bar', ax=ax, color='Grey', rot=360, width=0.6, edgecolor = "black", 
                                 xlabel='', ylabel='ΔG (kJ/mol)', legend=False, fontsize=28)
            ax3.set_ylabel(str(thermo)+"$_{a+b}$(kJ/mol)", fontsize=28, fontdict=dict(weight='bold'))
            ...
            if TC in ['2deoxy_ribofuranose', 'ribofuranose', 'threose', '2deoxy_ribopyranose', 'ribopyranose']:
             ...
             #   ax4.legend(['α-$^2T_3$', 'β-$^2T_3$', 'α-$^3T_2$', 'β-$^3T_2$'], loc='center left', bbox_to_anchor=(1, 0.5), fontsize=24)
...
db_nucleotides_cond_reaction = pd.DataFrame({'Environment': environment, 
                                             ...
                                             'zpE_nucleoside(kJ/mol)': zpE_nucleoside, 
                                             'corrE_nucleoside(kJ/mol)': corrE_nucleoside, 
                                             'H_nucleoside(kJ/mol)': H_nucleoside, 
                                             'G_nucleoside(kJ/mol)': G_nucleoside, 
...
db_nucleotides_cond_reaction['TdS_nucleoside(kJ/mol)'] = db_nucleotides_cond_reaction['H_nucleoside(kJ/mol)'] - db_nucleotides_cond_reaction['G_nucleoside(kJ/mol)']
...
# For dzpE
db_nucleotides_cond_reaction['ΔzpE_reaction_a(kJ/mol)'] = (db_nucleotides_cond_reaction['zpE_water(kJ/mol)'] + db_nucleotides_cond_reaction['zpE_nucleoside(kJ/mol)']) - (db_nucleotides_cond_reaction['zpE_RU(kJ/mol)'] + db_nucleotides_cond_reaction['zpE_TC(kJ/mol)'])
                                                                                                                   
db_nucleotides_cond_reaction['ΔzpE_reaction_b(kJ/mol)'] = (db_nucleotides_cond_reaction['zpE_water(kJ/mol)'] + db_nucleotides_cond_reaction['zpE_nucleotide(kJ/mol)']) - (db_nucleotides_cond_reaction['zpE_nucleoside(kJ/mol)']+ db_nucleotides_cond_reaction['zpE_IL(kJ/mol)'])
                                                                                                                                                                      
db_nucleotides_cond_reaction['ΔE_reaction(kJ/mol)'] = db_nucleotides_cond_reaction['ΔzpE_reaction_a(kJ/mol)'] + db_nucleotides_cond_reaction['ΔzpE_reaction_b(kJ/mol)']


# For corrE
db_nucleotides_cond_reaction['ΔcorrE_reaction_a(kJ/mol)'] = (db_nucleotides_cond_reaction['corrE_water(kJ/mol)'] + db_nucleotides_cond_reaction['corrE_nucleoside(kJ/mol)']) - (db_nucleotides_cond_reaction['corrE_RU(kJ/mol)'] + db_nucleotides_cond_reaction['corrE_TC(kJ/mol)'])
                                                          
db_nucleotides_cond_reaction['ΔcorrE_reaction_b(kJ/mol)'] = (db_nucleotides_cond_reaction['corrE_water(kJ/mol)'] + db_nucleotides_cond_reaction['corrE_nucleotide(kJ/mol)']) - (db_nucleotides_cond_reaction['corrE_nucleoside(kJ/mol)']+ db_nucleotides_cond_reaction['corrE_IL(kJ/mol)'])
                                                                                                              
db_nucleotides_cond_reaction['ΔE(ZPE)_reaction(kJ/mol)'] = db_nucleotides_cond_reaction['ΔcorrE_reaction_a(kJ/mol)'] + db_nucleotides_cond_reaction['ΔcorrE_reaction_b(kJ/mol)']


# For dH
db_nucleotides_cond_reaction['ΔH_reaction_a(kJ/mol)'] = (db_nucleotides_cond_reaction['H_water(kJ/mol)'] + db_nucleotides_cond_reaction['H_nucleoside(kJ/mol)']) - (db_nucleotides_cond_reaction['H_RU(kJ/mol)'] + db_nucleotides_cond_reaction['H_TC(kJ/mol)'])
                                                          
db_nucleotides_cond_reaction['ΔH_reaction_b(kJ/mol)'] = (db_nucleotides_cond_reaction['H_water(kJ/mol)'] + db_nucleotides_cond_reaction['H_nucleotide(kJ/mol)']) - (db_nucleotides_cond_reaction['H_nucleoside(kJ/mol)'] + db_nucleotides_cond_reaction['H_IL(kJ/mol)'])
                                                                                                              
db_nucleotides_cond_reaction['ΔH°_reaction(kJ/mol)'] = db_nucleotides_cond_reaction['ΔH_reaction_a(kJ/mol)'] + db_nucleotides_cond_reaction['ΔH_reaction_b(kJ/mol)']


# For TdS
db_nucleotides_cond_reaction['Δ(TdS)_reaction_a(kJ/mol)'] = (db_nucleotides_cond_reaction['TdS_water(kJ/mol)'] + db_nucleotides_cond_reaction['TdS_nucleoside(kJ/mol)']) - (db_nucleotides_cond_reaction['TdS_RU(kJ/mol)'] + db_nucleotides_cond_reaction['TdS_TC(kJ/mol)'])
                                                            
db_nucleotides_cond_reaction['Δ(TdS)_reaction_b(kJ/mol)'] = (db_nucleotides_cond_reaction['TdS_water(kJ/mol)'] + db_nucleotides_cond_reaction['TdS_nucleotide(kJ/mol)']) - (db_nucleotides_cond_reaction['TdS_nucleoside(kJ/mol)'] + db_nucleotides_cond_reaction['TdS_IL(kJ/mol)'])
                                                            
db_nucleotides_cond_reaction['Δ(TΔS°)_reaction(kJ/mol)'] = db_nucleotides_cond_reaction['Δ(TdS)_reaction_a(kJ/mol)'] + db_nucleotides_cond_reaction['Δ(TdS)_reaction_b(kJ/mol)']
                                                                                                                    

# For dG
db_nucleotides_cond_reaction['ΔG_reaction_a(kJ/mol)'] = (db_nucleotides_cond_reaction['G_water(kJ/mol)'] + db_nucleotides_cond_reaction['G_nucleoside(kJ/mol)']) - (db_nucleotides_cond_reaction['G_RU(kJ/mol)'] + db_nucleotides_cond_reaction['G_TC(kJ/mol)'])
                                                          
db_nucleotides_cond_reaction['ΔG_reaction_b(kJ/mol)'] = (db_nucleotides_cond_reaction['G_water(kJ/mol)'] + db_nucleotides_cond_reaction['G_nucleotide(kJ/mol)']) - (db_nucleotides_cond_reaction['G_nucleoside(kJ/mol)'] + db_nucleotides_cond_reaction['G_IL(kJ/mol)'])
                                                                                                              
db_nucleotides_cond_reaction['ΔG°_reaction(kJ/mol)'] = db_nucleotides_cond_reaction['ΔG_reaction_a(kJ/mol)'] + db_nucleotides_cond_reaction['ΔG_reaction_b(kJ/mol)']  

# Convert pandas dataframe to csv file
db_nucleotides_cond_reaction.to_csv('condensation_reaction_allData_nucleotides_a+b_'+str(IL_name)+'.csv', index=False)                                           

# Read the csv file with all info
db = pd.read_csv ('condensation_reaction_allData_nucleotides_a+b_'+str(IL_name)+'.csv')
...
# Change name of TC conformations in final df
#for i, ring_conf_fura in enumerate(Ring_Conf_furanose):
    # Change name of ring conf fura in the field of this final dataframe
#    db['Initial_sugar_ring_conf'] = db['Initial_sugar_ring_conf'].str.replace(ring_conf_fura, new_ring_conf_fura[i])
    
#for i, ring_conf_pyra in enumerate(Ring_Conf_pyranose):
    # Change name of RUs in the field of this final dataframe
#    db['Initial_sugar_ring_conf'] = db['Initial_sugar_ring_conf'].str.replace(ring_conf_pyra,new_ring_conf_pyra[i])
