...
#	f_pseudorot_equil_nucleotides_a+b.sh
...
# To run script type:
# ./f_pseudorot_equil_nucleotides_a+b.sh.sh
...
echo $zero_point_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_ring_pseudorot_equilibrium/$IL/$TC/"$ring_conf"_zero_point_energies.txt
echo $corrected_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_ring_pseudorot_equilibrium/$IL/$TC/"$ring_conf"_corrected_energies.txt
echo $enthalpy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_ring_pseudorot_equilibrium/$IL/$TC/"$ring_conf"_enthalpies.txt
echo $free_energy >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_ring_pseudorot_equilibrium/$IL/$TC/"$ring_conf"_free_energies.txt
...
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_ring_pseudorot_equilibrium

# Create IL folder inside the post-processing folder
for IL in "${IL_names[@]}"; do
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_ring_pseudorot_equilibrium/$IL

# Create TC folder inside the post-processing folder
for TC in "${TC_names[@]}"; do
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_ring_pseudorot_equilibrium/$IL/$TC
done
...
def gen_freq_hist (dataframe, thermo, TC, IL):
    ...
    plt.tight_layout()
    plt.savefig('pseudo_rot_'+str(thermo)+'_'+str(TC)+'_'+str(IL)+'.pdf')
