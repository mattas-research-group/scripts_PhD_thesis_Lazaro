...
#
# To run script type:
# chmod u+x calc_puckering_params_graphs_csv_files_nucleo_a+b_v1.sh 
# ./calc_puckering_params_graphs_csv_files_nucleo_a+b_v1.sh
...
echo "$ring_conformation_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/final_ring_conformation_C_P_furanoses.txt
echo "$q2_amplitude_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/q2_C_P_furanoses.txt
echo "$total_amplitude_Q_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/total_amplitude_Q_C_P_furanoses.txt
echo "$phase_angle_phi2_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/phase_angle_phi2_Q_C_P_furanoses.txt
echo "$RU" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/RU_names_furanoses.txt
echo "$TC" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/TC_names_furanoses.txt
echo "$ring_conf" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/initial_ring_conf_furanoses.txt
echo "$environment" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/environment_list_furanoses.txt
echo "$IL" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/IL_names_furanoses.txt
...
# Output variables in general files inside the environment folder depending on the ring type
echo "$ring_conformation_pyra_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/final_ring_conformation_C_P_pyranoses.txt
echo "$q2_amplitude_pyra_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/q2_C_P_pyranoses.txt
echo "$q3_amplitude_pyra_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/q3_C_P_pyranoses.txt
echo "$total_amplitude_Q_pyra_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/total_amplitude_Q_C_P_pyranoses.txt
echo "$phase_angle_phi2_pyra_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/phase_angle_phi2_Q_C_P_pyranoses.txt
echo "$phase_angle_theta_C_P" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/phase_angle_theta_Q_C_P_pyranoses.txt
echo "$RU" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/RU_names_pyranoses.txt
echo "$TC" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/TC_names_pyranoses.txt
echo "$ring_conf" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/initial_ring_conf_pyranoses.txt
echo "$environment" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/environment_list_pyranoses.txt
echo "$IL" >> $MD_RUN/nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC/IL_names_furanoses.txt
...
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering

# Create IL folder inside the post-processing folder
for IL in "${IL_names[@]}"; do
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL

# Create TC folder inside the post-processing folder
for TC in "${TC_names[@]}"; do
mkdir nucleotides_a+b/post_proc_summary_results_csv_graphs/sugar_puckering/$IL/$TC
done
done
