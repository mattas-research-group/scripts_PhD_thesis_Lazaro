...
initial_df = pd.read_csv('condensation_reaction_allData_nucleotides_a+b_arsenate.csv')
...
list_thermo = ['zpE_nucleotide(kJ/mol)', 'corrE_nucleotide(kJ/mol)', 'G_nucleotide(kJ/mol)']
